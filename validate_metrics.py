...
from tta_utils import parse_angles, tta_denoise
...
def main():
    ...
    parser.add_argument("--data_config", default="configs/data/train_enhanced.yaml")
    ...
    parser.add_argument("--output_csv", default="experiments/enhanced_vm/validation_metrics.csv")
    ...
    if args.tta:
        print(f"tta_angles: {args.tta_angles}")
        print(f"tta_iterations: {args.tta_iterations}")
        print(f"bilateral: {args.bilateral}")
